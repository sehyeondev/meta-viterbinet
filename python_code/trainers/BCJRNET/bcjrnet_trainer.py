from python_code.detectors.BCJRNET.bcjrnet_detector import BCJRNETDetector
...
class BCJRNETTrainer(Trainer):
    ...
    def initialize_detector(self):
        ...
        """
        self.detector = BCJRNETDetector(n_states=self.n_states,
